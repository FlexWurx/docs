...
sidebarTitle: "Invite Resource Users"
---
...
1. Select the _Property_ or _Portfolio_ button to invite user(s) to either a specific set of properties or portfolios.
